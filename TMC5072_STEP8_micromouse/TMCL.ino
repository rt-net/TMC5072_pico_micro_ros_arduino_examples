...
void ExecuteActualCommand()
{
    ...
    switch(ActualCommand.Type){
      ...
      case 5:
        ...
        break;
          ...
          TMC5072Write(TMC5072_IHOLD_IRUN1,((Read_Value &(~(0x00001F00)))|(((ActualCommand.Value.Int32)<<8)&(0x00001F00))));
        }else{
					Read_Value = TMC5072Read(TMC5072_IHOLD_IRUN2,&ActualReply.Status);
          TMC5072Write(TMC5072_IHOLD_IRUN2,((Read_Value &(~(0x00001F00)))|(((ActualCommand.Value.Int32)<<8)&(0x00001F00))));
        }
        break;
			...
			case 7:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_IHOLD_IRUN1,&ActualReply.Status);
          TMC5072Write(TMC5072_IHOLD_IRUN1,((Read_Value &(~(0x1F)))|(((ActualCommand.Value.Int32))&(0x1F))));
        }else{
					Read_Value = TMC5072Read(TMC5072_IHOLD_IRUN2,&ActualReply.Status);
          TMC5072Write(TMC5072_IHOLD_IRUN2,((Read_Value &(~(0x1F)))|(((ActualCommand.Value.Int32))&(0x1F))));
        }
        break;
			case 12:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_SW_MODE1,&ActualReply.Status);
          TMC5072Write(TMC5072_SW_MODE1,((Read_Value &(~(0x02)))|((((ActualCommand.Value.Int32 > 0)? 1:0)<<1)&(0x02))));
					Read_Value = TMC5072Read(TMC5072_SW_MODE1,&ActualReply.Status);
					TMC5072Write(TMC5072_SW_MODE1,((Read_Value &(~(0x08)))|((((ActualCommand.Value.Int32 == 2)? 1:0)<<3)&(0x08))));
				}else{
					Read_Value = TMC5072Read(TMC5072_SW_MODE2,&ActualReply.Status);
          TMC5072Write(TMC5072_SW_MODE2,((Read_Value &(~(0x02)))|((((ActualCommand.Value.Int32 > 0)? 1:0)<<1)&(0x02))));
					Read_Value = TMC5072Read(TMC5072_SW_MODE2,&ActualReply.Status);
					TMC5072Write(TMC5072_SW_MODE2,((Read_Value &(~(0x08)))|((((ActualCommand.Value.Int32 == 2)? 1:0)<<3)&(0x08))));
				}
        break;
			case 13:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_SW_MODE1,&ActualReply.Status);
          TMC5072Write(TMC5072_SW_MODE1,((Read_Value &(~(0x01)))|((((ActualCommand.Value.Int32 > 0)? 1:0))&(0x01))));
					Read_Value = TMC5072Read(TMC5072_SW_MODE1,&ActualReply.Status);
					TMC5072Write(TMC5072_SW_MODE1,((Read_Value &(~(0x04)))|((((ActualCommand.Value.Int32 == 2)? 1:0)<<2)&(0x04))));
				}else{
					Read_Value = TMC5072Read(TMC5072_SW_MODE2,&ActualReply.Status);
          TMC5072Write(TMC5072_SW_MODE2,((Read_Value &(~(0x01)))|((((ActualCommand.Value.Int32 > 0)? 1:0))&(0x01))));
					Read_Value = TMC5072Read(TMC5072_SW_MODE2,&ActualReply.Status);
					TMC5072Write(TMC5072_SW_MODE2,((Read_Value &(~(0x04)))|((((ActualCommand.Value.Int32 == 2)? 1:0)<<2)&(0x04))));
        }
        break;
			case 14:
				if(ActualCommand.Motor==0){
      ...
      case 18://0x12
        ...
        break;
          ...
          TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x040000)))|(((ActualCommand.Value.Int32)<<18)&(0x040000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x040000)))|(((ActualCommand.Value.Int32)<<18)&(0x040000))));
        }
        break;
			case 140:
				switch(ActualCommand.Value.Int32)
				{
				case 1:    ActualCommand.Value.Int32 = 8;   break;
				case 2:    ActualCommand.Value.Int32 = 7;   break;
				case 4:    ActualCommand.Value.Int32 = 6;   break;
				case 8:    ActualCommand.Value.Int32 = 5;   break;
				case 16:   ActualCommand.Value.Int32 = 4;   break;
				case 32:   ActualCommand.Value.Int32 = 3;   break;
				case 64:   ActualCommand.Value.Int32 = 2;   break;
				case 128:  ActualCommand.Value.Int32 = 1;   break;
				case 256:  ActualCommand.Value.Int32 = 0;   break;
				default:   ActualCommand.Value.Int32 = -1;  break;
				}
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_CHOPCONG1,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x0F000000)))|(((ActualCommand.Value.Int32)<<24)&(0x0F000000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x0F000000)))|(((ActualCommand.Value.Int32)<<24)&(0x0F000000))));
        }
        break;
			case 162:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_CHOPCONG1,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x018000)))|(((ActualCommand.Value.Int32)<<15)&(0x018000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x018000)))|(((ActualCommand.Value.Int32)<<15)&(0x018000))));
        }
        break;
			case 163:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_CHOPCONG1,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x2000)))|(((ActualCommand.Value.Int32)<<13)&(0x2000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x2000)))|(((ActualCommand.Value.Int32)<<13)&(0x2000))));
        }
        break;
			case 164:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_CHOPCONG1,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x1000)))|(((ActualCommand.Value.Int32)<<12)&(0x1000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x1000)))|(((ActualCommand.Value.Int32)<<12)&(0x1000))));
        }
        break;
			case 165:
				if(ActualCommand.Motor==0){
					...
					if(Read_Value){
          	TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x0780)))|(((ActualCommand.Value.Int32)<<7)&(0x0780))));
					}else{
						TMC5072Write(TMC5072_CHOPCONG1,((((Read_Value &(~(0x0800)))|(((ActualCommand.Value.Int32)<<11)&(0x0800))) & (1<<3))? 1:0));
						TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x70)))|(((ActualCommand.Value.Int32)<<4)&(0x70))));
					}
				}else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
					Read_Value = (Read_Value & 0x4000) >>14;
          if(Read_Value){
          	TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x0780)))|(((ActualCommand.Value.Int32)<<7)&(0x0780))));
					}else{
						TMC5072Write(TMC5072_CHOPCONG2,((((Read_Value &(~(0x0800)))|(((ActualCommand.Value.Int32)<<11)&(0x0800))) & (1<<3))? 1:0));
						TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x70)))|(((ActualCommand.Value.Int32)<<4)&(0x70))));
					}
				}
        break;
			case 166:
        ...
        break;
			case 167:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_CHOPCONG1,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x0F)))|(((ActualCommand.Value.Int32))&(0x0F))));
        }else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x0F)))|(((ActualCommand.Value.Int32))&(0x0F))));
        }
        break;
			case 168:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_COOLCONF1,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF1,((Read_Value &(~(0x8000)))|(((ActualCommand.Value.Int32)<<15)&(0x8000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_COOLCONF2,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF2,((Read_Value &(~(0x8000)))|(((ActualCommand.Value.Int32)<<15)&(0x8000))));
        }
        break;
			case 169:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_COOLCONF1,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF1,((Read_Value &(~(0x6000)))|(((ActualCommand.Value.Int32)<<13)&(0x6000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_COOLCONF2,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF2,((Read_Value &(~(0x6000)))|(((ActualCommand.Value.Int32)<<13)&(0x6000))));
        }
        break;
			case 170:
				if(ActualCommand.Motor==0){
        ...
        break;
			case 171:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_COOLCONF1,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF1,((Read_Value &(~(0x60)))|(((ActualCommand.Value.Int32)<<5)&(0x60))));
        }else{
					Read_Value = TMC5072Read(TMC5072_COOLCONF2,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF2,((Read_Value &(~(0x60)))|(((ActualCommand.Value.Int32)<<5)&(0x60))));
        }
        break;
			case 172:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_COOLCONF1,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF1,((Read_Value &(~(0x0F)))|(((ActualCommand.Value.Int32))&(0x0F))));
        }else{
					Read_Value = TMC5072Read(TMC5072_COOLCONF2,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF2,((Read_Value &(~(0x0F)))|(((ActualCommand.Value.Int32))&(0x0F))));
        }
        break;
			case 173:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_COOLCONF1,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF1,((Read_Value &(~(0x01000000)))|(((ActualCommand.Value.Int32)<<15)&(0x01000000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_COOLCONF2,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF2,((Read_Value &(~(0x01000000)))|(((ActualCommand.Value.Int32)<<15)&(0x01000000))));
        }
        break;
			case 174:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_COOLCONF1,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF1,((Read_Value &(~(0x7F0000)))|(((ActualCommand.Value.Int32)<<16)&(0x7F0000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_COOLCONF2,&ActualReply.Status);
          TMC5072Write(TMC5072_COOLCONF2,((Read_Value &(~(0x7F0000)))|(((ActualCommand.Value.Int32)<<16)&(0x7F0000))));
        }
        break;
			case 179:
				if(ActualCommand.Motor==0){
					Read_Value = TMC5072Read(TMC5072_CHOPCONG1,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG1,((Read_Value &(~(0x020000)))|(((ActualCommand.Value.Int32)<<17)&(0x020000))));
        }else{
					Read_Value = TMC5072Read(TMC5072_CHOPCONG2,&ActualReply.Status);
          TMC5072Write(TMC5072_CHOPCONG2,((Read_Value &(~(0x020000)))|(((ActualCommand.Value.Int32)<<17)&(0x020000))));
        }
        break;
			case 181:
				if(ActualCommand.Motor==0){
					...
					Read_Value = TMC5072Read(TMC5072_SW_MODE1,&ActualReply.Status);
          TMC5072Write(TMC5072_SW_MODE1,(((Read_Value &(~(0x0400)))|(((ActualCommand.Value.Int32)<<10)&(0x0400)))? 1:0));
        }else{
					TMC5072Write(TMC5072_VCOOLTHRS2,ActualCommand.Value.Int32);
					Read_Value = TMC5072Read(TMC5072_SW_MODE2,&ActualReply.Status);
          TMC5072Write(TMC5072_SW_MODE2,(((Read_Value &(~(0x0400)))|(((ActualCommand.Value.Int32)<<10)&(0x0400)))? 1:0));
        }
        break;
			case 182:
				if(ActualCommand.Motor==0){
    ...
    switch(ActualCommand.Type){    
      ...
      case 3:
        if(ActualCommand.Motor==0){
          ActualReply.Value.Int32 = CAST_Sn_TO_S32(TMC5072Read(TMC5072_VACTUAL1, &ActualReply.Status),24);
        }else{
          ActualReply.Value.Int32 = CAST_Sn_TO_S32(TMC5072Read(TMC5072_VACTUAL2, &ActualReply.Status),24);
        }
        break;
			case 4:
        if(ActualCommand.Motor==0){
...
//  TMC5072Setting(STEPDIR); 
  ...
  TMC5072Write(TMC5072_AMAX1,2000/TMC5072_VELOCITY);//TMCL_RORで速度指令だけで回るように加速度を0から任意値に設定
